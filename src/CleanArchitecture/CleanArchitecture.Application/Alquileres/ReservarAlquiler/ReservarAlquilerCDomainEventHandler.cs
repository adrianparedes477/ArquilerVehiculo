...
internal sealed class ReservarAlquilerCDomainEventHandler
: INotificationHandler<AlquilerReservadoDomainEvent>
{
    ...
    public ReservarAlquilerCDomainEventHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _emailService.SeedAsync(
            user.Email!,
            "Alquiler Reservado",
            "Tienes q confirmar esta reserva de lo contrario se perdera"
        );
    }
}
